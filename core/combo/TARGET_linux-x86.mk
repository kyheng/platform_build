...
ifneq ($(strip $(wildcard prebuilts/gcc/$(HOST_PREBUILT_EXTRA_TAG)/x86/i686-linux-android-$(TARGET_GCC_VERSION))),)
TARGET_TOOLCHAIN_ROOT := prebuilts/gcc/$(HOST_PREBUILT_EXTRA_TAG)/x86/i686-linux-android-$(TARGET_GCC_VERSION)
else
